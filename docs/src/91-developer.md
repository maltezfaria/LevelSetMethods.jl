...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/maltezfaria/LevelSetMethods.jl
   ```
...
- After that runs, the [stable docs](https://maltezfaria.github.io/LevelSetMethods.jl/stable) should be updated. Check them and look for the version number.
